...
def typeconversion(data):
    ...
    personal_data_dict = {
        ...
        "dobBS": personal_data.get("dateOfBirthInBs"),
        ...
        "citizenshipIssueDateBS": citizen_data['bsIssueDate'],
        "passportNumber":pass_data['passportNumber'],
        "passportIssueDistrict":pass_data['issuePlace'],
        "passportIssueDateBS":pass_data['bsIssueDate'],
        "passportExpireDateBS" : pass_data['expiryDateBs'],
        "bankName": "xyz",
        ...
        "NomineeCtzIssueDateBS": nominee_data['nomineeDocumentIssueBS'],
        "NomineeCtzIssueDateAD":nominee_data['nomineeDocumentIssueAD'] ,
        ...
        "file13":{"value":download_image(birth_data.get("selfieImage")) ,"field":"NomineeThumbRight"},
        "file14":{"value":download_image(birth_data.get("selfieImage")) ,"field":"NomineeThumbLeft"},
        "file15":{"value":download_image(citizen_data.get("frontImage")) ,"field":"NomineeCtzFront"},
        "file16":{"value":download_image(citizen_data.get("frontImage")) ,"field":"NomineeCtzBack"},
        "file17":{"value":download_image(cred_data.get("signatureImage")) ,"field":"NomineeSignature"},
